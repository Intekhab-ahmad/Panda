...
def greetMe():
    ...
    if currentH >= 0 and currentH < 12:
        speak('Good Morning! Paradox sir')

    if currentH >= 12 and currentH < 18:
        speak('Good Afternoon! Paradox sir')

    if currentH >= 18 and currentH !=0:
        speak('Good Evening! Paradox sir')
...
class Widget:
    def __init__(self):
       ...
       root.resizable(2000,1075)
       img = ImageTk.PhotoImage(Image.open(r"G:\wow.jpg"))
       ...
       userFrame = LabelFrame(root, text="PARADOX", font=('Black ops one', 10, 'bold'))
       ...
       compFrame = LabelFrame(root, text="PANDA", font=('Black ops one', 10, 'bold'))
       ...
       speak('Hello, I am Panda! What should I do for You?')
       self.compText.set('Hello, I am Panda! What should I do for You?')
